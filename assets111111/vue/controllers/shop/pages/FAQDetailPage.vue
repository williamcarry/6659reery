    ...
    <main>
      ...
      <section class="hc-container" style="padding: 20px 0;" :key="faqId">
        <div class="div" v-if="faqItem">
          <!-- 面包屑导航 -->
          <div class="div-2">
            <a href="/help-center" class="a">帮��中心</a>
            <i class="i">></i>
...
.hc-header__inner {
  display: flex; align-items: center; justify-content: space-between; padding: 24px 0; gap: 24px;
...
.hc-footer__inner {
  ...
  margin-right: -28px; padding: 48px 0 40px;
}
...
.hc-footer__partners-list {
  ...
  margin-right: -20px; list-style: none; padding: 0; margin: 0;
}
