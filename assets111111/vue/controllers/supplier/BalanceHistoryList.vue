  ...
  <div class="balance-history-container">
    ...
    <el-card class="table-card">
      ...
      >
        ...
        <el-table-column prop="balanceBefore" label="变化前金额" min-width="200">
          <template #default="scope">
        ...
        <el-table-column prop="amount" label="变化金额" min-width="200" sortable>
          <template #default="scope">
        ...
        <el-table-column prop="balanceAfter" label="变化后金额" min-width="200" sortable>
          <template #default="scope">
            <div class="balance-cell multi-line">
              <div class="line-item">
                <span class="label">可用余额：</span>
...
const getTypeCustomClass = (type) => {
  const customClasses = {
    ...
    'order_frozen': 'type-order-frozen',   // 订单冻结 - 橙色
    'order_confirmed': 'type-order-confirmed' // 订单确认 - 绿色
  }
...
// 获取带符号的货币显示
const getCurrencyDisplayWithSign = (amount) => {
