  ...
  <div class="menu-item-list-container">
    ...
    <div class="page-header">
      ...
      <div class="header-actions">
        <el-button type="danger" @click="batchDeleteItems" :disabled="selectedItems.length === 0" :icon="DeleteIcon">
          批量删除
        </el-button>
    ...
    <el-card class="filter-card">
      <div class="filter-header">
        <el-icon class="filter-icon"><SearchIcon /></el-icon>
      ...
      <el-form :model="searchForm" class="search-form" label-position="left" label-width="80px">
        <el-row :gutter="20"   style="display: flex;justify-content: flex-end;">
          <el-col :span="5" :xs="24" style="width: 300px;">
          ...
          <el-col :span="8" :xs="24">
            <el-form-item label=" " :label-width="'10px'">
              <div class="form-actions">
                <el-button type="primary" @click="searchItems" :icon="SearchIcon">
                  搜索记录
                </el-button>
                <el-button @click="resetSearch" :icon="RefreshLeftIcon">
                  重置条件
                </el-button>
              </div>
            </el-form-item>
...
import { Menu, Plus, List, Delete, Search, RefreshLeft } from '@element-plus/icons-vue'
...
const filteredSubcategories = computed(() => {
  if (!props.menuSubcategories || !Array.isArray(props.menuSubcategories)) {
    return []
  }
  if (searchForm.value.categoryId === 0) {
    return props.menuSubcategories
  }
  return props.menuSubcategories.filter(
    sub => sub.categoryId === searchForm.value.categoryId
  )
})
...
const handleCategoryChange = () => {
  // 重置二级分类选择
  searchForm.value.subcategoryId = 0
}
...
const searchItems = () => {
  ...
  window.dispatchEvent(new CustomEvent('menu-item-search', { 
    detail: { 
      page: 1,
      loginPath: loginPath,
...
const handlePageChange = (page) => {
  ...
  const loginPath = props.adminLoginPath || window.adminLoginPath || '';
  // 触发页面更改事件并传递搜索条件
  window.dispatchEvent(new CustomEvent('menu-item-page-changed', { 
    detail: { 
      page: page, 
      loginPath: loginPath,
      categoryId: searchForm.value.categoryId,
