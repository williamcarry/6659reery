          ...
          <el-col :span="8" :xs="24">
            <el-form-item label=" " :label-width="'10px'">
              <div class="form-actions">
                <el-button type="primary" @click="searchSubcategories" :icon="SearchIcon">
                  搜索记录
                </el-button>
...
import { Menu, Plus, List, Search, RefreshLeft } from '@element-plus/icons-vue'
...
const handlePageChange = (page) => {
  ...
  const loginPath = props.adminLoginPath || window.adminLoginPath || '';
  // 触发页面更改事件并传递搜索条件
  window.dispatchEvent(new CustomEvent('menu-subcategory-page-changed', { 
    detail: { 
      page: page, 
      loginPath: loginPath,
...
const searchSubcategories = () => {
  currentPage.value = 1
  const loginPath = props.adminLoginPath || window.adminLoginPath || '';
  window.dispatchEvent(new CustomEvent('menu-subcategory-search', { 
    detail: { 
      page: 1,
      loginPath: loginPath,
      categoryId: searchForm.value.categoryId
